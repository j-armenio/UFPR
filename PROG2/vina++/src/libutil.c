...
/* Recebe uma string com o caminho de um arquivo e retorna esse caminho em formato de caminho relativo. */
...
// Retorna em formato octal as permissões de um arquivo
...
// Cria os diretórios necessários para um arquivo
